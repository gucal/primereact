...
const classes = {
    ...
    item: ({ suggestion, optionGroupLabel, index, focusedOptionIndex, isSelected }) =>
        optionGroupLabel ? classNames('p-autocomplete-item', { 'p-disabled': suggestion.disabled }) : classNames('p-autocomplete-item', { 'p-disabled': suggestion.disabled, 'bg-red-500': index === focusedOptionIndex, 'p-highlight': isSelected }),
